class Response < ActiveRecord::Base
  ...
  def persist_setup
    ...
    self.question.question_dimensions.each do |qd|
      rd = self.response_dimensions.new count: qd.count, legend_description: qd.legend_description, help_text_image: qd.help_text_image, help_text_description: qd.help_text_description
      rd.image = qd.image
    end
